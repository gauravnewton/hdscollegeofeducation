...
--
-- Host: 127.0.0.1:3308
-- Generation Time: Sep 09, 2020 at 04:56 PM
...
(1, 'Google', 'SEO,Google', 'A', '', 'D', 'C', 'H', 'E', 'G', 'Commercial Cat', 'Edu Cat', 'Home cat', 'Reports7.csv', 'CSV', 1, '(admin)', 0);
...
(1, 1, 'A', 'First Name', 0),
(2, 1, 'B', 'Modeling Software', 0),
(3, 1, 'C', 'Country', 0),
(4, 1, 'D', 'Company / Account', 0),
(5, 1, 'E', 'Phone', 0),
(6, 1, 'F', 'Industry', 0),
(7, 1, 'G', 'Create Date', 0),
(8, 1, 'H', 'Email', 0);
